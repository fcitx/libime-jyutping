...
static const auto finalMap = makeBimap<JyutpingFinal, std::string>({
    ...
    {JyutpingFinal::OU, "ou"},     {JyutpingFinal::ON, "on"},
    {JyutpingFinal::ONG, "ong"},   {JyutpingFinal::OT, "ot"},
    {JyutpingFinal::OK, "ok"},     {JyutpingFinal::OE, "oe"},
    {JyutpingFinal::OENG, "oeng"}, {JyutpingFinal::OEK, "oek"},
    {JyutpingFinal::EOI, "eoi"},   {JyutpingFinal::EON, "eon"},
    {JyutpingFinal::EOT, "eot"},   {JyutpingFinal::U, "u"},
    {JyutpingFinal::UI, "ui"},     {JyutpingFinal::UN, "un"},
    {JyutpingFinal::UNG, "ung"},   {JyutpingFinal::UT, "ut"},
    {JyutpingFinal::UK, "uk"},     {JyutpingFinal::YU, "yu"},
    {JyutpingFinal::YUN, "yun"},   {JyutpingFinal::YUT, "yut"},
    {JyutpingFinal::M, "m"},       {JyutpingFinal::NG, "ng"},
    {JyutpingFinal::Zero, ""},
});
